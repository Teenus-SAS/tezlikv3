      ...
      },
      {
        ...
        render: function (data) {
          return `
                    ...
                    <a href="javascript:;" <i id="${data}" class="mdi mdi-delete-forever deletePCMachine" data-toggle='tooltip' title='Eliminar Maquina' style="font-size: 30px;color:red"></i></a>`;
        },
      },
    ],
  });
