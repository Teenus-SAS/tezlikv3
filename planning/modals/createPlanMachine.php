                            ...
                            <div class="col-md-12 col-lg-12 InputGroup">
                                <form id="formCreatePlanMachine">
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="hourStart" name="hourStart" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="january" name="january" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="february" name="february" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="march" name="march" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="april" name="april" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="may" name="may" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="june" name="june" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="july" name="july" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="august" name="august" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="september" name="september" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="october" name="october" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="november" name="november" type="text" class="form-control text-center">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group floating-label enable-floating-label show-label">
                                                <input id="december" name="december" type="text" class="form-control text-center">
