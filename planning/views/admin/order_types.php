...
<head>
    ...
    <title>TezlikSoftware Planning | Order Types</title>
                                    ...
                                    <div class="card">
                                        <div class="card-body pt-3 pb-0">
                                            <div class="gridx4ip">
                                                ...
                                                <div class="form-group floating-label enable-floating-label show-label" style="margin-bottom:0px;margin-top:7px">
                                                    <button type="text" class="btn btn-info" id="btnDownloadImportsOrderTypes"><i class="fas fa-download"></i> Descargar Formato</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
