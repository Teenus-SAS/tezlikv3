...
class GeneralProductsProcessDao
{
    ...
    public function findAllProductsprocess($id_company)
    {
        ...
        $stmt = $connection->prepare("SELECT pp.id_product_process, p.id_product, pc.id_process, p.reference, p.product, pp.enlistment_time, pp.operation_time, IFNULL(mc.machine, 'PROCESO MANUAL') AS machine, pc.process,
