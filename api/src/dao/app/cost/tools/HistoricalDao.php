...
class HistoricalDao
{
    ...
    // public function findAllHistoricalByMonth($id_company)
    // {
    //     $connection = Connection::getInstance()->getConnection();
    ...
    //                                     LEFT JOIN expenses_recover er ON er.id_product = p.id_product
    //                                     LEFT JOIN families f ON f.id_family = p.id_family
    //                                   WHERE p.id_company = :id_company AND hp.month = :month");
    //     $stmt->execute([
    //         'id_company' => $id_company,
    //         'month' => $month
    //     ]);
    ...
    // public function findAllHistoricalByYear($id_company)
    // {
    //     $connection = Connection::getInstance()->getConnection();
    ...
    //                                     LEFT JOIN expenses_recover er ON er.id_product = p.id_product
    //                                     LEFT JOIN families f ON f.id_family = p.id_family
    //                                   WHERE p.id_company = :id_company AND hp.year = :year");
    //     $stmt->execute([
    //         'id_company' => $id_company,
    //         'year' => $year
    //     ]);
