...
class ReportCostDao
{
    ...
    public function findAllCostByCompany($id_company)
    {
        ...
        $sql = "SELECT p.reference AS Referencia, p.product AS Producto, pc.cost_materials AS Materia_Prima, pc.cost_workforce AS Mano_de_Obra, pc.cost_indirect_cost AS Costos_Indirectos, exp.assignable_expense AS Gasto_CostoFijo
