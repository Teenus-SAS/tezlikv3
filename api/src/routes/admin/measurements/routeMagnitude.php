...
$app->group('/magnitudes', function (RouteCollectorProxy $group) use ($magnitudesDao) {

    $group->post('/add', function (Request $request, Response $response, $args) use ($magnitudesDao) {
    ...
    $group->post('/update', function (Request $request, Response $response, $args) use ($magnitudesDao) {
        $dataMagnitude = $request->getParsedBody();
    ...
    $group->get('/delete/{id_magnitude}', function (Request $request, Response $response, $args) use ($magnitudesDao) {
