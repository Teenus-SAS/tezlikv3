...
$app->group('/users', function (RouteCollectorProxy $group) {
    ...
    $group->post('/addUser', function (Request $request, Response $response, $args) {
        $userDao = new UsersDao();
    ...
    $group->post('/newUserAndCompany', function (Request $request, Response $response, $args) {
        $userDao = new UsersDao();
        $generateCodeDao = new GenerateCodeDao();
        $makeEmailDao = new SendMakeEmailDao();
        $sendEmailDao = new SendEmailDao();
    ...
    $group->post('/updateUser', function (Request $request, Response $response, $args) {
    ...
    $group->post('/deleteUser', function (Request $request, Response $response, $args) {
    ...
    $group->post('/changePrincipalUser', function (Request $request, Response $response, $args) {
    ...
    $group->get('/changeActiveUser/{id_user}/{op}', function (Request $request, Response $response, $args) {
