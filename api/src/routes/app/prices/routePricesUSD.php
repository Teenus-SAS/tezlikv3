...
// Agrupar todas las rutas de trm bajo el prefijo '/trm'
$app->group('/trm', function (RouteCollectorProxy $group) {

    /* Consultar dolar actual */
    $group->get('/currentDollar', function (Request $request, Response $response, $args) {
        $trmDao = new TrmDao();
    ...
    $group->post('/simPriceUSD', function (Request $request, Response $response, $args) {
        $trmDao = new TrmDao();
    ...
    $group->get('/priceUSD/{coverage_usd}', function (Request $request, Response $response, $args) {
