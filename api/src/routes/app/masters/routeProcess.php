...
$app->group('/process', function (RouteCollectorProxy $group) {
    ...
    $group->post('/processDataValidation', function (Request $request, Response $response, $args) {
    ...
    $group->post('/addProcess', function (Request $request, Response $response, $args) {
    ...
    $group->post('/updateProcess', function (Request $request, Response $response, $args) {
    ...
    $group->post('/saveRouteProcess', function (Request $request, Response $response, $args) {
    ...
    $group->get('/deleteProcess/{id_process}', function (Request $request, Response $response, $args) {
