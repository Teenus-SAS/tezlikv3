...
$app->group('/machines', function (RouteCollectorProxy $group) {
    ...
    $group->post('/machinesDataValidation', function (Request $request, Response $response, $args) {
    ...
    /* Agregar Maquinas */
    $group->post('/addMachines', function (Request $request, Response $response, $args) {
        // session_start();
        $id_company = $_SESSION['id_company'];
    ...
    /* Actualizar Maquina */
    $group->post('/updateMachines', function (Request $request, Response $response, $args) {
        // session_start();
        $id_company = $_SESSION['id_company'];
        $coverage_usd = $_SESSION['coverage_usd'];
        $dataMachine = $request->getParsedBody();
    ...
    /* Eliminar Maquina */
    $group->post('/deleteMachine', function (Request $request, Response $response, $args) {
        // session_start();
        $id_company = $_SESSION['id_company'];
        $coverage_usd = $_SESSION['coverage_usd'];
        $dataMachine = $request->getParsedBody();
