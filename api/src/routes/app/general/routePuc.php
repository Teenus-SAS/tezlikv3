...
$app->group('/puc', function (RouteCollectorProxy $group) use ($pucDao) {

    $group->get('', function (Request $request, Response $response, $args) use ($pucDao) {
    ...
    $group->post('/addPuc', function (Request $request, Response $response, $args) use ($pucDao) {
    ...
    $group->post('/updatePuc', function (Request $request, Response $response, $args) use ($pucDao) {
        $dataPuc = $request->getParsedBody();
    ...
    $group->get('/deletePuc/{id_puc}', function (Request $request, Response $response, $args) use ($pucDao) {
