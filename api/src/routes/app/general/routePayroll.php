...
$app->group('/payroll', function (RouteCollectorProxy $group) {
    ...
    $group->get('/basicPayroll', function (Request $request, Response $response, $args) {
    ...
    $group->get('/salarynet', function (Request $request, Response $response, $args) {
    ...
    $group->get('/process/{employee}', function (Request $request, Response $response, $args) {
    ...
    $group->post('/addPayroll', function (Request $request, Response $response) {
    ...
    $group->post('/updatePayroll', function (Request $request, Response $response, $args) {
    ...
    $group->post('/copyPayroll', function (Request $request, Response $response, $args) {
    ...
    $group->post('/saveRoutePayroll', function (Request $request, Response $response, $args) {
    ...
    $group->post('/deletePayroll', function (Request $request, Response $response, $args) {
    ...
    /* 
    $group->get('/checkEmployee/{employee}', function (Request $request, Response $response, $args) {
