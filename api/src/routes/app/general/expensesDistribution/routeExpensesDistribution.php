...
$app->group('/distribution', function (RouteCollectorProxy $group) {

    $group->get('/expensesDistribution', function (Request $request, Response $response, $args) {
    ...
    $group->get('/allProductsDistribution', function (Request $request, Response $response, $args) {
    ...
    $group->get('/expensesDistributionProducts', function (Request $request, Response $response, $args) {
    ...
    $group->get('/expenseTotal', function (Request $request, Response $response, $args) {
    ...
    $group->post('/expenseDistributionDataValidation', function (Request $request, Response $response, $args) {
        ...
        if (isset($dataExpensesDistribution)) {
            ...
            for ($i = 0; $i < sizeof($expensesDistribution); $i++) {
                ...
                $data = floatval($expensesDistribution[$i]['unitsSold']) * floatval($expensesDistribution[$i]['turnover']);
    ...
    $group->post('/addExpensesDistribution', function (Request $request, Response $response, $args) {
    ...
    $group->post('/updateExpensesDistribution', function (Request $request, Response $response, $args) {
    ...
    $group->post('/deleteExpensesDistribution', function (Request $request, Response $response, $args) {
        $expensesDistributionDao = new ExpensesDistributionDao();
        $generalProductsDao = new GeneralProductsDao();
        $assignableExpenseDao = new AssignableExpenseDao();
        $priceProductDao = new PriceProductDao();
    ...
    $group->post('/saveNewProduct', function (Request $request, Response $response, $args) {
