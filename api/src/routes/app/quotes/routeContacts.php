...
$app->group('/companies', function (RouteCollectorProxy $group) use ($contactsDao) {
    ...
    $group->get('/contactsByCompany/{id_company}', function (Request $request, Response $response, $args) use ($contactsDao) {
    ...
    $group->post('/addContact', function (Request $request, Response $response, $args) use ($contactsDao) {
    ...
    $group->post('/updateContact', function (Request $request, Response $response, $args) use ($contactsDao) {
        $dataContact = $request->getParsedBody();
    ...
    $group->get('/deleteContact/{id_contact}', function (Request $request, Response $response, $args) use ($contactsDao) {
