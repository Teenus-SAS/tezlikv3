...
// Agrupar todas las rutas de dashboard bajo el prefijo '/dashboard'
$app->group('/panelGeneral', function (RouteCollectorProxy $group) {

    /* Consulta todos */
    $group->get('/dashboardExpensesGenerals', function (Request $request, Response $response, $args) {
    ...
    $group->post('/updateCosts', function (Request $request, Response $response, $args) {
