...
$app->group('/factoryLoad', function (RouteCollectorProxy $group) {
    ...
    $group->post('/factoryLoadDataValidation', function (Request $request, Response $response, $args) {
    ...
    $group->post('/addFactoryLoad', function (Request $request, Response $response, $args) {
                ...
                if ($factoryLoad == null) {
                    ...
                    foreach ($dataProducts as $arr) {
                        ...
                        if (isset($data['totalPrice']))
                            $factoryLoad = $generalProductsDao->updatePrice($arr['id_product'], $data['totalPrice']);
                        if (isset($factoryLoad['info'])) break;
    ...
    $group->post('/updateFactoryLoad', function (Request $request, Response $response, $args) {
    ...
    $group->post('/deleteFactoryLoad', function (Request $request, Response $response, $args) {
