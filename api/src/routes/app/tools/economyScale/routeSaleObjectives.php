...
$app->group('/saleObjectives', function (RouteCollectorProxy $group) use ($saleObjectivesDao) {

    $group->get('', function (Request $request, Response $response, $args) use ($saleObjectivesDao) {
    ...
    $group->post('/saveSaleObjectives', function (Request $request, Response $response, $args) use ($saleObjectivesDao) {
        $id_company = $_SESSION['id_company'];
