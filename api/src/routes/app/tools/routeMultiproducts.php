...
use tezlikv3\dao\{GeneralProductsDao, MultiproductsDao};
...
// Agrupar todas las rutas de multiproducts bajo el prefijo '/multiproducts'
$app->group('/multiproducts', function (RouteCollectorProxy $group) {
    ...
    $group->post('/multiproductsDataValidation', function (Request $request, Response $response, $args) {
    ...
    $group->post('/addMultiproduct', function (Request $request, Response $response, $args) {
        $multiproductsDao = new MultiproductsDao();
        $productsDao = new GeneralProductsDao();
