...
$app->group('/simulator', function (RouteCollectorProxy $group) {

    $group->get('/dashboardPricesSimulator/{id_product}', function (Request $request, Response $response, $args) {
    ...
    $group->post('/addSimulator', function (Request $request, Response $response, $args) {
