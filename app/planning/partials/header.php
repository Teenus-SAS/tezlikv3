                            ...
                            <div class="row" id="nav">
                                <div class="col-md-3" id="navBasics">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        <li class="createMachines"><a href="javascript:void(0);" onclick="loadContent('page-content','planning/views/operations/basic/createMachines.php')">Planeación Máquinas</a></li>
                                        <!-- <li class="createProducts"><a href="javascript:void(0);" onclick="loadContent('page-content','views/operations/basic/createProducts.php')">Planeación Productos</a></li>
                                         <li class="createMaterials"><a href="javascript:void(0);" onclick="loadContent('page-content','views/operations/basic/createRawMaterials.php')">Planeación Materia Prima</a></li> 
