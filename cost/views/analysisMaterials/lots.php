...
<body class="horizontal-navbar">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-7 col-xl-6 form-inline justify-content-sm-end">
                                <div class="col-xs-2 py-2">
                                    <button class="btn btn-warning" id="btnRawMaterialsAnalysis">Analisar Materias Primas</button>
                                </div>
    ...
    <script src="/cost/js/analysisMaterials/lots/lots.js"></script>
    <script src="/cost/js/analysisMaterials/lots/tblProducts.js"></script>
    <script src="/cost/js/analysisMaterials/lots/tblAnalysisMaterials.js"></script>
    <script src="/cost/js/analysisMaterials/lots/calcAnalysisMaterials.js"></script>
</body>
