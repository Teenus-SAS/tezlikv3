                                ...
                                <div class="col-sm-7 col-xl-6 form-inline justify-content-sm-end">
                                    ...
                                    <?php if ($_SESSION['flag_currency_usd'] == 1) { ?>
                                        ...
                                        <div class="col-xs-2 mr-2 form-group floating-label enable-floating-label mt-4">
                                            ...
                                            <label for="selectTypeExpense">Moneda</label>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane cardProductsProcess" style="display: none;">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-7 col-xl-6 form-inline justify-content-sm-end">
                                    ...
                                    <div class="col-xs-2 py-2 mr-2">
                                        <button class="btn btn-secondary btnDownloadXlsx" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Exporta Ficha Técnica"><i class="fas fa-cloud-upload-alt" style="font-size: 20px;"></i></button>
                                    </div>
                                    <?php if ($_SESSION['flag_currency_usd'] == 1) { ?>
                                        <!-- <div class="col-xs-2 py-2 mr-2">
                                            <button class="btn btn-sm btn-outline-primary" id="btnPriceUSD">Moneda (USD)</button>
