...
<head>
    ...
    <title>TezlikSoftware Cost | Prices List</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-5 col-xl-6">
                                <div class="page-title">
                                    <h3 class="mb-1 font-weight-bold text-dark"><i class="bi bi-list"></i>Lista de Precios</h3>
                ...
                <div class="page-content-wrapper mt--45 mb-5 cardCreatePricesList" style="display: none;">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
