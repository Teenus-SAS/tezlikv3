                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-5 col-xl-6">
                                <div class="page-title">
                                    <h3 class="mb-1 font-weight-bold text-dark"><i class="bi bi-graph-up mr-1"></i>Ventas Objetivo (Escalas)</h3>
                                    <ol class="breadcrumb mb-3 mb-md-0">
                                        <li class="breadcrumb-item active">Ventas minimos a vender de acuerdo con las unidades establecidas y la rentabilidad deseada.</li>
                                    </ol>
                                </div>
                            </div>
