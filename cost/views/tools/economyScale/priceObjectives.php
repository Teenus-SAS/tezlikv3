                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-5 col-xl-6">
                                <div class="page-title">
                                    <h3 class="mb-1 font-weight-bold text-dark"><i class="bi bi-graph-up mr-1"></i>Precios Objetivo (Unidades)</h3>
                                    <ol class="breadcrumb mb-3 mb-md-0">
                                        <li class="breadcrumb-item active">Precio de producto minimo a vender para cumplir con el margen requerido</li>
                                    </ol>
                                </div>
                            </div>
