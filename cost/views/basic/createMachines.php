...
<head>
    ...
    <title>TezlikSoftware Cost | Machines</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-5 col-xl-6">
                                <div class="page-title">
                                    <h3 class="mb-1 font-weight-bold text-dark"><i class="bi bi-gear-wide mr-1"></i>Máquinas</h3>
                            ...
                            <div class="col-sm-7 col-xl-6 form-inline justify-content-sm-end">
                                ...
                                <div class="col-xs-2 py-2 mr-2">
                                    <button class="btn btn-info" id="btnImportNewMachines" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Importar Máquinas"><i class="fas fa-upload" style="font-size: 20px;"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="page-content-wrapper mt--45 mb-5 cardCreateMachines" style="display: none;">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                ...
                <div class="page-content-wrapper mt--45 mb-5 cardImportMachines" style="display: none;">
                    <div class="container-fluid">
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body pt-3">
                                        <div class="form-row" id="formMachines">
                                            ...
                                            <div class="col-xs-2 cardBottons" style="margin-top:7px">
                                                <button type="text" class="btn btn-info" id="btnDownloadImportsMachines"><i class="fas fa-download"></i> Descargar Formato</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
