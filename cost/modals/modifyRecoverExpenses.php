    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="btnCloseExpensesRecover">Cerrar</button>
                <button type="button" class="btn btn-primary" id="btnUpdateExpensesRecover">Actualizar</button>
            </div>
        </div>
    </div>
</div>