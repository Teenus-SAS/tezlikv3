...
$('#btnSaveFamily').click(function (e) {
  ...
  if (idFamily == '' || idFamily == null)
    checkDataFamily('/api/distributionByFamilies/addFamily', idFamily);
  else checkDataFamily('/api/distributionByFamilies/updateFamily', idFamily);
});
...
deleteFamily = () => {
  ...
  bootbox.confirm({
    ...
    callback: function (result) {
      if (result == true) {
        $.get(`/api/distributionByFamilies/deleteFamily/${id_family}`, function (data, textStatus, jqXHR) {
...
deleteExpenseDistributionFamilies = () => {
  ...
  bootbox.confirm({
    ...
    callback: function (result) {
      if (result == true) {
        $.get(
          `/api/distributionByFamilies/deleteExpensesDistributionFamily/${id_family}`,
...
$('#btnAddProductFamily').click(function (e) {
  ...
  $.post('/api/distributionByFamilies/saveProductFamily', data, function (data, textStatus, jqXHR) {
...
deleteProductFamily = () => {
  ...
  bootbox.confirm({
    ...
    callback: function (result) {
      if (result == true) {
        $.post(
          '/api/distributionByFamilies/saveProductFamily',
          dataFamily,
          function (data, textStatus, jqXHR) {
            messageDistribution(data, 4);
          }
