$(document).ready(function () {
  $('#typeExpense').change(function (e) {
    ...
    // else if (value == 2) loadTableRecoverExpenses();
  });
  ...
  loadTableRecoverExpenses = () => {
    tblRecoverExpenses = $('#tblExpenses').dataTable({
      destroy: true,
      pageLength: 50,
      ajax: {
        url: '../../api/expensesDistribution',
      ...
      columns: [
        ...
        {
          title: 'Acciones',
          data: 'id_recover_expense',
          className: 'uniqueClassName',
          render: function (data) {
            return `
            <a href="javascript:;" <i id="${data}" class="bx bx-edit-alt updateRecoverExpense" data-toggle='tooltip' title='Actualizar Gasto' style="font-size: 30px;"></i></a>    
            <a href="javascript:;" <i id="${data}" class="mdi mdi-delete-forever" data-toggle='tooltip' title='Eliminar Gasto' style="font-size: 30px;color:red" onclick="deleteFunction()"></i></a>`;
          },
        },
      ],
