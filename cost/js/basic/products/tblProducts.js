      ...
      },
      {
        ...
        render: function (data) {
          return `
                  ...
                  <a href="javascript:;" <i id="${data.id_product}" class="bx bx-copy-alt cloneProduct" data-toggle='tooltip' title='Clonar Producto' style="font-size: 30px; color:green"></i></a>
