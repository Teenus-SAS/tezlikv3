$(document).ready(function () {
  getDataCost = (data) => {
    ...
    cost = cost_materials + cost_workforce + cost_indirect_cost + services;
    ...
    let recomendedPrice = turnover / parseFloat(data.units_sold);
