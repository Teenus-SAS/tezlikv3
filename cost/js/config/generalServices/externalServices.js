...
$('#btnAddService').click(function (e) {
  ...
  if (idService == '' || idService == null) {
    checkDataServices('/api/generalServices/addGExternalService', idService);
  } else {
    checkDataServices('/api/generalServices/updateGExternalService', idService);
  }
});
...
$(document).on('click', '.deleteExternalService', function (e) {
  ...
  bootbox.confirm({
    ...
    callback: function (result) {
      if (result == true) {
        $.post(
          '/api/generalServices/deleteGExternalService',
          dataExternalService,
