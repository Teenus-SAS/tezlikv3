      ...
      },
      {
        ...
        render: function (data) {
          return `
              ...
              <a href="javascript:;" <i id="${data}" class="mdi mdi-delete-forever deleteExternalService" data-toggle='tooltip' title='Eliminar Servicio' style="font-size: 30px;color:red" onclick="deleteService()"></i></a>`;
        },
      },
    ],
