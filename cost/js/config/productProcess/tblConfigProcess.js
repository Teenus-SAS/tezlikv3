    ...
    tblConfigProcess = $('#tblConfigProcess').dataTable({
      ...
      columns: [
        ...
        }, */
        {
          ...
          render: function (data) {
            return `
                <a href="javascript:;" <i id="${data}" class="ti-exchange-vertical updateEmployee" data-toggle='tooltip' title='Configurar cantidad Empleados' style="font-size: 30px; color:orange;"></i></a>    
